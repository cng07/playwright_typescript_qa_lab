...
- Name: db/users/constraints.spec.ts >> DB - Users Constraints @db @db_constraints >> Constraint: Emails should have valid format
- Location: tests/db/users/constraints.spec.ts:48:7
