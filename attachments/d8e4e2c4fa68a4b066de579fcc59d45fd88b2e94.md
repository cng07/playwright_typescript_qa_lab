...
- Name: db/users.db.spec.ts >> DB - Users @db >> DB: Column naming should remain consistent
- Location: tests/db/users.db.spec.ts:57:7
...
Expected value: "Nationality"
Received array: ["id", "first_name", "email", "created_at", "last_name", "nationality", "role", "instance_id", "id", "aud", …]
```
